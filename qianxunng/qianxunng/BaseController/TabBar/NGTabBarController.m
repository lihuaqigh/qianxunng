...
- (void)setupAllChildVc {
    ...
    [self addChildVcWithName:@"NGSearchController" title:@"搜索" image:[UIImage imageNamed:@"tabbar_discver"] selectedImage:[UIImage imageWithOriginalName:@"tabbar_discver_select"]];
